...
config = {
  ...
  "dataset_name": "fromgames",
  "grad_cam_result_dataset": "fromgames",
  "log_to_file": False,
  "device_name": "cuda:0",
  "input_size": [3, 256, 60],
  "win_drive": "G",
...
# Raw examples
save_base_path = "/home/trex22/Downloads/fromgames_example_crop/"
helper_functions.detect_or_create_folder(save_base_path)

example_image_path = '/data/data/fromgames/images/15722.png'
original_image = image_functions.open_image(example_image_path)
image_functions.save_image(original_image, f"{save_base_path}fromgames_example.png")

cropped_image = image_functions.crop_image_with_roi(original_image, roi=config["roi"]["fromgames"])
image_functions.save_image(cropped_image, f"{save_base_path}fromgames_example_crop.png")

# Groups
log("Compute Group Examples ...", config)
save_base_path = "/home/trex22/Downloads/fromgames_group_examples/"
helper_functions.detect_or_create_folder(save_base_path)
...
save_base_path = "/home/trex22/Downloads/fromgames_label_examples/"
helper_functions.detect_or_create_folder(save_base_path)
