...
def run_simple_test(config):
  log('===========================================', config)
  log(f'=== Dataset: {config["dataset_name"]} ({config["input_size"]}) ===', config)
  log('===========================================', config)
  ...
  # train_avg, train_min, train_max = stats(train_ds)
  # valid_avg, valid_min, valid_max = stats(valid_ds)
  # test_avg, test_min, test_max = stats(test_ds)

  # log(f'\nAverages: train_avg: {train_avg}, valid_avg: {valid_avg}, test_avg: {test_avg}', config)
  # log(f'Min: train_min: {train_min}, valid_min: {valid_min}, test_min: {test_min}', config)
  # log(f'Max: train_max: {train_max}, valid_max: {valid_max}, test_max: {test_max}', config)

  # log(f'Train count: {len(train_ds)}', config)
  # meta = data_functions.drop_dataframe_if_zero_angle(train_ds, percent=config["grad_cam_drop_percentage"], precision=config["data_drop_precision"], ignore_value='')
...
if __name__ == '__main__':
  ...
  for dataset_name in available_datasets:
    ...
    for input_size in available_input_sizes:
